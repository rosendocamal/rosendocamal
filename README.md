...
Actualmente curso el 4to cuatrimestre de Ingeniería (Modalidad Ejecutiva). Mi enfoque está en aprender las bases de la programación y el análisis de datos, utilizando la lógica matemática como herramienta principal para resolver problemas.
